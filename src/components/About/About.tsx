        ...
        <div className='md:grid md:grid-cols-2 gap-8 items-center py-8 sm:px-1 xl:gap-10 '>
            ...
            <div className='mt-4 md:mt-0 text-left flex flex-col h-full'>
                ...
                <p className='text-base lg:text-md'>
                    Hi there!
                    my name is Victor Edidiong Samuel, I am a Full-stack web developer with over three years of experience in area of computer programming . 
                ...
                <p className='pt-5'>
                    My specialties include Javascript, React and Next js and am always looking for opportunities to apply this skills to create intuitive and user-friendly web applications. 
